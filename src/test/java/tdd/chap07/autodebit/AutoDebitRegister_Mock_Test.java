...
public class AutoDebitRegister_Mock_Test {
	...
	private AutoDebitInfoRepository repository = Mockito.mock(MemoryAutoDebitInfoRepository.class);
	...
	@Test
	void validCard() {
		given(cardNumberValidator.validate(anyString()))
				.willReturn(CardValidity.VALID);
